...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/06 14:27:54 by matde-je          #+#    #+#             */
/*   Updated: 2024/04/06 14:27:58 by matde-je         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	render_tex(int i)
{
	...
	while (++y < cub3()->tex[i].height)
	{
		...
		{
			cub3()->tex_arr[i][cub3()->tex[i].height * y
				+ x] = (cub3()->tex[i].addr[cub3()->tex[i].height * y + x]);
		}
	}
}
